...
\begin{itemize}
    ...
    \end{figure}
    \item \textbf{\ce{S_{N}2}}: Bimolecular nucleophilic substitution. \emph{Also known as} \textbf{backside attack}.
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item \textbf{\ce{S_{N}1}}: Unimolecular nucleophilic substitution.
    \begin{itemize}
    ...
    \item Key requirement: Predict whether a reaction proceeds through an \ce{S_{N}1} or \ce{S_{N}2} mechanism.
    \begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Take-home message: A good nucleophile favors \ce{S_{N}2}.
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item \ce{S_{N}1} is favored.
            \end{itemize}
            \item Primary alkyl halides.
            \begin{itemize}
                \item Backside is wide open.
                \item Carbocation is unstable.
                \item \ce{S_{N}2} is favored.
            \end{itemize}
            \item For \ce{S_{N}2} reactions, sterics matter (affect the rate) a lot.
            \begin{itemize}
                \item Neopentyl alkyl halides block \ce{S_{N}2} reactions.
            \end{itemize}
        ...
        \item Leaving group.
        \begin{itemize}
            \item Important for both \ce{S_{N}1} and \ce{S_{N}2} reactions.
