...
\begin{itemize}
        ...
        \begin{subfigure}[b]{\linewidth}
            ...
            \schemestart
                ...
                \subscheme{
                    ...
                    \arrow{<->}
                    \chemname{\chemfig{[:18]*5(-?-(<[@{wb}:-35]@{Br4}\charge{90=\:,-90=\:,45:3pt=$\oplus$}{Br}?[,5])----)}}{Bromonium ion}
                    \arrow{<->}
    ...
    \end{equation*}
    \begin{itemize}
        \item \ce{NaBH4} is a very good hydrogen source (more on this second and third quarter).
